...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2022 a las 19:26:34
...
INSERT INTO `empleado` (`id`, `nombre`, `email`, `sexo`, `area_id`, `boletin`, `descripcion`, `deleted`) VALUES
(3, 'Pedro Pérez', 'pperez@example.co', 'M', 5, 1, 'Hola mundo', 0),
(4, 'Amalia Bayona', 'abayona@example.co', 'F', 8, 0, 'Para contactar a Amalia Bayona, puede escribir al correo electrónico abayona@example.co', 0),
(5, 'Juan Soto Castro', 'soto131@live.com', 'F', 7, NULL, 'Descripción del empleado editado', 1);
